...
public class IntroState extends GameState {
	...
	private String[] messages = { "Our Deep Water Marine Life Research Bases have stopped responding!",
			...
			"Use AWSD to move. Use Left and Right Arrows to switch view. Press and hold E in a Window to shine light. Press ESC to pull up the menu in-game.",
	...
	public void render() {
		...
		g.drawString(Assets.font, messages[msgIndex], new Vector2f(0, 50), new Vector2f(Window.getWidth() / 250f),
				new Color(255, 255, 255, alpha), Window.getWidth() / 5f, g.FONT_CENTER);
		g.drawString(Assets.font, "Press Space", new Vector2f(0, -20), new Vector2f(Window.getWidth() / 300f),
				new Color(255, 255, 255, alpha), g.FONT_CENTER);
	}
